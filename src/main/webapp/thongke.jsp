...
<div class="container py-4">
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6">
            <div class="card d-flex flex-row align-items-center justify-content-between">
                ...
                <div class="progress-ring" data-percent="${percentDoanhThu}">
        ...
        <div class="col-md-6">
            <div class="card d-flex flex-row align-items-center justify-content-between">
                <div>
                    ...
                    <div class="fs-5 text-info">${tongVe} vé</div>
                </div>

                <div class="progress-ring" data-percent="${percentVe}">
                    <svg viewBox="0 0 100 100">
                        <circle class="bg" cx="50" cy="50" r="45"></circle>
                        <circle class="fg" cx="50" cy="50" r="45"></circle>
                    </svg>
    ...
    <!-- Chi tiết vé -->
    <div class="section-title mt-4 mb-2">Chi tiết vé đã bán</div>
        ...
        <table class="table table-dark table-bordered align-middle text-center">
            ...
            <tbody>
                <c:forEach var="s" items="${ticketStats}">
                    ...
                    <tr>
                        <td>${s.typeName}</td>
                        <td><fmt:formatNumber value="${s.price}" type="number"/>đ</td>
                        <td>${s.soldTickets}</td>
