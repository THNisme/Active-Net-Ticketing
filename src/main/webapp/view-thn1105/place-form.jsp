<%-- 
    Document   : place-form
    Created on : Nov 11, 2025, 11:27:29 AM
    Author     : BACH YEN
--%>
...
<html lang="vi">
    ...
    <body>
        <div class="container mt-5">
            <h3 class="mb-4">Thêm nơi tổ chức</h3>
            <!-- Nav tabs -->
            ...
            <div class="tab-content my-5">
                ...
                <div class="tab-pane fade show active" id="step1" role="tabpanel">
                    <!-- FORM CREATE PLACE -->
                    <form id="placeForm" action="placeform?action=create" method="POST" enctype="multipart/form-data">
                        <div class="row mb-3">
                            <div class="col">
                                <div class="drag-wrap">
                                    <label class="dropzone" id="dropzone">
                                        <input id="fileInput" type="file" accept="image/* " name="zoneImage" required>
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="eventName" name="placeName" required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="placeDescription" name="placeDescription" required>
                                </div>

                                <!--                                <div class="mb-3">
                                                                    <label for="placeStatus" class="form-label"><strong style="color: red;">* </strong>Trạng thái</label>
                                                                    <select class="form-select" aria-label="Default select example" id="placeStatus" required>
