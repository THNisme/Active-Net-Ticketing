...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Staff - Đơn đã xác nhận</title>
    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <a class="active" href="${pageContext.request.contextPath}/staff/orders-confirmed">
                ✔ Đơn đã xác nhận
            </a>
        ...
        <div class="content">
            ...
            <div class="subtitle">Danh sách các đơn đã được duyệt và gửi vé cho khách.</div>
            ...
            <div class="card">
                ...
                <table>
                    ...
                    <c:if test="${empty orders}">
                        <tr>
                            <td colspan="7" class="empty-row">Chưa có đơn nào đã xác nhận.</td>
                        </tr>
                    </c:if>
