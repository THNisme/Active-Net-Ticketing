 ...
 * @author NGUYEN
 */
public class StatisticsOffAllEnvent {
    ...
    public StatisticsOffAllEnvent() {
    }

    public StatisticsOffAllEnvent(String eventName, int totalTickets, int soldTickets, double totalRevenue) {
