...
import DAOs.nttn0902.EventDetailsDAO;
 ...
 * @author NGUYEN
 */
@WebServlet(name = "ViewDetailsServlet", urlPatterns = {"/viewdetails"})
public class ViewDetailsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ViewDetailsServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ViewDetailsServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        EventDetails event = dao.getEventDetailsById(eventId);
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/Views/nttn0902/ViewDetails.jsp");
