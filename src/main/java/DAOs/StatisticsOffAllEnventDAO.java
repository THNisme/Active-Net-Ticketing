...
import Models.StatisticsOffAllEnvent;
import java.sql.*;
 ...
 * @author NGUYEN
 */
public class StatisticsOffAllEnventDAO {

    private Connection conn = DBContext.getInstance().getConnection();

     public List<StatisticsOffAllEnvent> getThongKeTheoSuKien() {
        List<StatisticsOffAllEnvent> list = new ArrayList<>();
        ...
        try {
            ...
            while (rs.next()) {
                StatisticsOffAllEnvent tk = new StatisticsOffAllEnvent();
